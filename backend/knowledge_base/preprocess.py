        ...
        if file.endswith(".txt"):
            ...
            with open(output_path, "w", encoding="utf-8") as out:
                for i, chunk in enumerate(chunks):
                    entry = {"id": f"{file}_{i}", "text": chunk, "category": category}
...
if __name__ == "__main__":
    preprocess_text(
        "knowledge_base/extracted_text/ifrs", "knowledge_base/processed_chunks/ifrs", "ifrs"
    )
    preprocess_text(
        "knowledge_base/extracted_text/tax_code",
